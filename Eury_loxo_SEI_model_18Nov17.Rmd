...
*Requirements*
  ...
  b. download and place folder 'Gehman_etal_Code_2017' on your desktop
...
#     The output of the nonlinear least squares fit gives estimates of c, T0, Tm.  
      ...
      beta.data<-read.csv("parasite_rep_27Aug17.csv")  
...
#1.c The data for susceptible expected lifespan over temperature fit to a Briere (Fig. 1C). The output of the nonlinear least squares fit gives estimates of c, T0, Tm.   
      ...
      S.data=read.csv("Susceptible_lifespan_27Aug17.csv") #add the path for the directory you are working in to access this data
...
# 1d. The data for exposed expected lifespan over temperature fit to a modified Briere (Fig. 1D). The output of the nonlinear least squares fit gives estimates of c, T0, Tm. 
      ...
      E.data=read.csv("Exposed_lifespan_27Aug17.csv") #add the path for the directory you are working in to access this data
...
#1e. The data for infected expected lifespan over temperature fit to a modified Briere (Fig. 1E). The output of the nonlinear least squares fit gives estimates of c, T0, Tm. 
      ...
      I.data=read.csv("Infected_lifespan_27Aug17.csv") #add the path for the directory you are working in to access this data
...
gce10.data=read.csv("gce10.wk.mean_6Dec15.csv") #add the path for the directory you are working in to access this data
